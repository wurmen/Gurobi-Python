...
```python
    ...
    if m.status == GRB.Status.OPTIMAL:
        ...
        for c in range(t):
            print 'Employees need from %d -%d: %d'%(c,c+1,staffNumber_sol[c])
...
```
    ...
    *    0     0               0    4670.0000000 4670.00000  0.00%     -    0s
    ...
    Employees need from 0 -1: 1
    Employees need from 1 -2: 1
    Employees need from 2 -3: 2
    Employees need from 3 -4: 3
    Employees need from 4 -5: 6
    Employees need from 5 -6: 6
    Employees need from 6 -7: 7
    Employees need from 7 -8: 8
    Employees need from 8 -9: 9
    Employees need from 9 -10: 8
    Employees need from 10 -11: 8
    Employees need from 11 -12: 8
    Employees need from 12 -13: 7
    Employees need from 13 -14: 6
    Employees need from 14 -15: 6
    Employees need from 15 -16: 5
    Employees need from 16 -17: 5
    Employees need from 17 -18: 4
    Employees need from 18 -19: 4
    Employees need from 19 -20: 3
    Employees need from 20 -21: 2
    Employees need from 21 -22: 2
    Employees need from 22 -23: 2
    Employees need from 23 -24: 2
